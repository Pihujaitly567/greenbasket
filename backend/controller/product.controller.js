...
export const addProduct = asyncHandler(async (req, res) => {
  ...
  if (offerPrice > price) {
    throw new AppError("Offer price cannot be greater than regular price", 400);
  }
  ...
  sendSuccess(res, 201, { product }, "Product added successfully");
});
...
// seed products: /api/product/seed (seller-only)
export const seedProducts = asyncHandler(async (req, res) => {
  ...
  sendSuccess(res, 201, {}, "Database seeded with products");
});
